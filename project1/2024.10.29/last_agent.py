...
class GridAdventureRLAgent(GridAdventureAgent):
    def __init__(self, load_q_table=False, q_table_filename='',epsilon=0.1):
        ...
        self.epsilon_decay = (self.epsilon - self.epsilon_min) / 20000  # 선형 감소
...
if __name__ == '__main__':
    ...
    agent = GridAdventureRLAgent(load_q_table=True, q_table_filename='2024.10.29/last_q-table_v4.pkl',epsilon=0.3)
    trained_agent, episode_rewards = agent.train(10000,True)
