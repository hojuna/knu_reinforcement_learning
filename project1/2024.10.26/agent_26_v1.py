...
class GridAdventureRLAgent(GridAdventureAgent):
    def __init__(self, load_q_table=False, q_table_filename='2024.10.26/knu_q_table_26_v1_test.pkl',epsilon=0.1):
        # 가능한 행동들 정의 (기본 행동)
...
if __name__ == '__main__':
    ...
    agent = GridAdventureRLAgent(load_q_table=True, q_table_filename='2024.10.26/knu_q_table_26_v1_best.pkl',epsilon=0)
