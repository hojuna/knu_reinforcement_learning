...
class GridAdventureRLAgent(GridAdventureAgent):
    def __init__(self, load_q_table=False, q_table_filename='/content/drive/MyDrive/knu/real_agent/BG_q_table_v3.pkl',epsilon=0.1):
        # 가능한 행동들 정의 (기본 행동)
...
if __name__ == '__main__':
    ...
    agent = GridAdventureRLAgent(load_q_table=False, q_table_filename='/content/drive/MyDrive/knu/real_agent/BG_q_table_v3.pkl',epsilon=0.3)
