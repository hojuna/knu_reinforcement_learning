...
class GridAdventureRLAgent(GridAdventureAgent):
    ...
    def custom_reward(self, current_position, action_index, next_position, grid, terminated):
        ...
        #이동 보상 먹었으면 초기화
        self.bfs_table[next_position[0], next_position[1]] = self.bfs_table[next_position[0], next_position[1]] * 0.9
...
if __name__ == '__main__':
    ...
    agent = GridAdventureRLAgent(load_q_table=False, q_table_filename='knu_q_table_v2.pkl')
