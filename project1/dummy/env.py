...
class GridAdventureRLAgent(GridAdventureAgent):
    def __init__(self, load_q_table=False, q_table_filename='knu_q_table_v6.pkl'):
        # 가능한 행동들 정의 (기본 행동)
    ...
    def train(self, num_episodes=10000):
        ...
        while episode < num_episodes:
            ...
            while not done:
                action, action_index = self.act(observation)
...
if __name__ == '__main__':
    ...
    agent = GridAdventureRLAgent(load_q_table=True, q_table_filename='knu_q_table_v6.pkl')
