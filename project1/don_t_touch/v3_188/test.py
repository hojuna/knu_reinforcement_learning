...
class GridAdventureRLAgent(GridAdventureAgent):
    def __init__(self, load_q_table=False, q_table_filename='/don_t_touch/v2_197/knu_q_table_26_v1.pkl',epsilon=0.1):
        # 가능한 행동들 정의 (기본 행동)
        ...
        while queue:
            ...
            for d in directions:
                ...
                if (0 <= new_row < rows and 0 <= new_col < cols and not visited[new_row][new_col]):
                    ...
                    if cell in {'E','AR','G'}:  # 벽과 용암은 통과 불가능
    ...
    def make_short_goal_path(self,grid):
        path = self.bfs_find_path(grid, (1,1), (24,24))
        if not path:
    ...
    def custom_reward(self, current_position, action_index, next_position, grid, terminated, cnt, step_count):
        ...
        if terminated and next_position == (24, 24):
            if 'G' not in self.reward_queue:
                goal_reward += 10000 * (1 - step_count / 2704)
    ...
    def act(self, observation):
        ...
        return self.knu_agent_actions[action_index]
    ...
    def train(self, num_episodes=10000):
        ...
        while episode < num_episodes:
            ...
            self.make_short_goal_path(grid)
...
if __name__ == '__main__':
    ...
    agent = GridAdventureRLAgent(load_q_table=True, q_table_filename='don_t_touch/v3_188/knu_test.pkl',epsilon=0)#기존에는 0.5로 10000만 정도 돌렸습니다.
    # trained_agent, episode_rewards = agent.train(10)
