...
if __name__ == '__main__':
    ...
    # agent = GridAdventureRLAgent(load_q_table=True, q_table_filename='last_q-table_v5.pkl',epsilon=0.1)
    ...
    # trained_agent, episode_rewards, _= result_agent.train(10000,False)
