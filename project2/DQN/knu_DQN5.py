...
# 8. 메인 학습 루프 구현
def main(checkpoint_path=None,start_episode=1):
    # WandB 초기화 (선택 사항)
    wandb.init(
    ...
    for episode in range(start_episode, num_episodes + 1):
        ...
        if episode % checkpoint_interval == 0:
            checkpoint_path = f'project2/checkpoint/dueling_dqn_checkpoint_episode_{episode}.pth'
...
if __name__ == "__main__":
    ...
    main(f"/home/comoz/main_project/knu_reinforcement_learning/project2/checkpoint/dueling_dqn_checkpoint_episode_31000.pth",31000)
