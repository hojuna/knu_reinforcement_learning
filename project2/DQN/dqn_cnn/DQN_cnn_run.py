...
def train_agent(agent, env, num_episodes=1000, max_steps=1000, checkpoint_path=None, log_interval=100):
    ...
    for episode in range(1, num_episodes + 1):
        ...
        # 체크포인트 저장 및 평가
        if checkpoint_path and episode % log_interval == 0:
            save_path = os.path.join(checkpoint_path, f"checkpoint_episode_{episode}.pth")
...
if __name__ == "__main__":
    ...
    # 체크포인트 저장 디렉토리 설정
    checkpoint_path = f"/home/comoz/main_project/knu_reinforcement_learning/project2/checkpoint7"
    ...
    log_interval = 1000  # 예: 100 에피소드마다 체크포인트 저장
        ...
        # 학습 시작
    train_agent(agent, env, num_episodes=num_episodes, max_steps=max_steps, checkpoint_path=checkpoint_path, log_interval=log_interval)
