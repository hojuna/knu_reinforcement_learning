...
class A2CAgent:
    def __init__(self, state_size, save_dir=f"/home/comoz/main_project/knu_reinforcement_learning/project2/A2C/A2C_v8/save_model"):
...
def worker(rank, shared_network, num_episodes,save_interval,return_dict,best_reward,sync_interval):
    ...
    for episode in range(num_episodes):
        ...
        return_dict[f"worker_{rank}_{episode}"] = {
            ...
            "visit_table_mean": agent.visit_table.mean()  # 평균 방문률
        }
...
if __name__ == "__main__":
    ...
    try:
        ...
        wandb.init(project="a2c_v1", name="a2c_v8")
            ...
            for key, value in return_dict.items():
                if key not in logged_keys:
                    ...
                    wandb.log({
                        ...
                        "visit_table_mean": value["visit_table_mean"]
                })
                    logged_keys.add(key)
            time.sleep(1)
