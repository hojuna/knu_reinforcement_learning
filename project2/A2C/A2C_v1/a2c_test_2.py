...
class A2CNetwork(nn.Module):
    def init(self, input_size, hidden_size, num_actions):
        super(A2CNetwork, self).init()
...
class A2CAgent(): # GridSurvivorAgent 상속 제거
    def __init__(self, state_size, save_dir=f"/home/comoz/main_project/knu_reinforcement_learning/project2/A2C/A2C_v1"):
        super().__init__()
...
def train(env, agent, num_episodes, save_interval=100):
    ...
    wandb.init(project="a2c_v1", name="a2c_v1")
    config = wandb.config
