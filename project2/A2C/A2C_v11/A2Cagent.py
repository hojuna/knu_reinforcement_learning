...
class A2CAgent(): # GridSurvivorAgent 상속 제거
    def __init__(self, state_size, save_dir=f"/home/comoz/main_project/knu_reinforcement_learning/project2/A2C/A2C_v11/save_model"):
        super().__init__()
    ...
    def preprocess_state(self,state):
        ...
        state_vector = torch.cat([
            ...
            torch.tensor([(self.visit_table[agent_pos] + 300) / 300.0], dtype=torch.float32, device=self.device)
        ])
